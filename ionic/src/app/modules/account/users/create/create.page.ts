            ...
            .then(
                ...
                (error: any) => {
                    if (error.status == 401) {
                        ...
                        this.helperService.toast('secondary', 'Your session has expired, please enter your credentials again.');
                    } else {
                        this.helperService.toast('danger', 'Error fetching users');
                    }
                }
            );
    }
            ...
            .then(
                (response: any) => {
                    if (response.error) {
                        ...
                        this.access_levels = [];
                        response.access_levels.forEach(access_level => {
